...
% define the projection acceleration parameters
opts.adi.projection.freq=5;
opts.adi.projection.ortho=0;
%opts.adi.projection.meth='lyapchol';
opts.adi.projection.meth='lyap';
%opts.adi.projection.meth='lyap2solve';

% when projection is active, a Arnoldi/Lanczos process for the residual
% approximation is used
opts.adi.res.maxiter = 10;
opts.adi.res.tol = 1e-6;
opts.adi.res.orth = 0;
...
eqn.C = fdm_2d_vector(n0,'.7<x<=.9');eqn.C=eqn.C';%randn(1,n0^2);
