...
%% Demos
% In order to introduce the user into the sss functions, the |example| folder 
% contains a "getting started"-demo for the sss toolbox:
% 
% * <sss_gettingStartedhelp.html |sss_gettingStarted|> - Introductory demo to sss toolbox 
%
% *Just type |sss_gettingStarted| in the Command Window and start getting to know our toolbox!*
